...
/**
 * Created by PETAR on 1/29/2017.
 */

public class SharePreferenceManager
{

    public static final String REG_BR="regBrValue";
    public static final String MARKA="markaValue";
    private static final String SETTINGS_NAME = "default_settings";
    private static SharePreferenceManager sSharedPrefs;
    ...
    public static SharePreferenceManager getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new SharePreferenceManager(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
